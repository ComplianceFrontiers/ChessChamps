...
return (
  <TitleBox>
      ...
      {variantdata.showShortDec && (
          <ShortDec dangerouslySetInnerHTML={{ __html: d2 }}></ShortDec>
      )}
      {variantdata.showShortDec && (
          <ShortDec dangerouslySetInnerHTML={{ __html: d3 }}></ShortDec>
      )}
