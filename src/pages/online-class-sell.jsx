...
const FAQPage = ({ data, location, pageContext }) => {
    ...
    return (
        ...
        >
            <SEO title="Online Class Purchase" pathname="/" />
            <PageBreadcrumb
                pageContext={pageContext}
                location={location}
                title="Online Class Purchase"
            />
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                >
                                    Parent's First Name: <span style={{ color: "red" }}>*</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                >
                                    Parent's Last Name: <span style={{ color: "red" }}>*</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                >
                                    Child's First Name: <span style={{ color: "red" }}>*</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                >
                                    Child's Last Name: <span style={{ color: "red" }}>*</span>
                                </label>
                                <input
                                    type="text"
